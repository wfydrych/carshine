            ...
            <div className='offer__textbox'>
                ...
                <div className='offer__textbox__container'>
                    ...
                    <div className='offer__textbox__container__box'>
                        <div className='offer__textbox__container__box__rectangle'></div>
                        <div className='offer__textbox__container__box__text'>
                        Wir achten bei jeder Dienstleistung auf kompromisslose Qualität und sind jederzeit für Sie da, wenn Sie eine individuelle Beratung wünschen. Wir sind Ihr kompetenter Partner, wenn es um die Pflege deines Autos geht.
                        </div>
                    </div>
                </div>
            </div>
